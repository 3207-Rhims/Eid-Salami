...
wheel.addEventListener("transitionend", () => {
  ...
  friendName.textContent = `From: ${friend}`;
  friendAvatar.textContent = friend.charAt(0).toUpperCase();
  ...
  const quote = `I just got ${result.label} Salami from ${friend} on Salami Spinner!`;
